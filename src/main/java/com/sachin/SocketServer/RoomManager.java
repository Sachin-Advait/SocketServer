...
public class RoomManager {
  ...
  private final Map<String, String> candidates = new ConcurrentHashMap<>(); // Map to hold offers
  ...
  public void setCandidates(String roomId, String offer) {
    candidates.put(roomId, offer); // Store the candidates for the room
  }
